...
* @see app/Http/Controllers/InvoiceController.php:38
...
/**
* @see \App\Http\Controllers\InvoiceController::json
* @see app/Http/Controllers/InvoiceController.php:111
* @route '/invoices/{invoice}/json'
*/
export const json = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
...
* @route '/invoices/{invoice}/json'
*/
json.url = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
...
* @route '/invoices/{invoice}/json'
*/
json.get = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: json.url(args, options),
    method: 'get',
})
...
* @route '/invoices/{invoice}/json'
*/
json.head = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: json.url(args, options),
    method: 'head',
})
...
* @route '/invoices/{invoice}/json'
*/
const jsonForm = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
* @route '/invoices/{invoice}/json'
*/
jsonForm.get = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: json.url(args, options),
    method: 'get',
})
...
* @route '/invoices/{invoice}/json'
*/
jsonForm.head = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
...
/**
* @see \App\Http\Controllers\InvoiceController::pdfImage
* @see app/Http/Controllers/InvoiceController.php:129
* @route '/invoices/{invoice}/pdf-image/{image}'
*/
export const pdfImage = (args: { invoice: number | { id: number }, image: string | number } | [invoice: number | { id: number }, image: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: pdfImage.url(args, options),
    method: 'get',
})

pdfImage.definition = {
    methods: ["get","head"],
    url: '/invoices/{invoice}/pdf-image/{image}',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/invoices/{invoice}/pdf-image/{image}'
*/
pdfImage.url = (args: { invoice: number | { id: number }, image: string | number } | [invoice: number | { id: number }, image: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            invoice: args[0],
            image: args[1],
    ...
    return pdfImage.definition.url
            .replace('{invoice}', parsedArgs.invoice.toString())
...
* @route '/invoices/{invoice}/pdf-image/{image}'
*/
pdfImage.get = (args: { invoice: number | { id: number }, image: string | number } | [invoice: number | { id: number }, image: string | number ], options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: pdfImage.url(args, options),
    method: 'get',
})
...
* @route '/invoices/{invoice}/pdf-image/{image}'
*/
pdfImage.head = (args: { invoice: number | { id: number }, image: string | number } | [invoice: number | { id: number }, image: string | number ], options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: pdfImage.url(args, options),
    method: 'head',
})
...
* @route '/invoices/{invoice}/pdf-image/{image}'
*/
const pdfImageForm = (args: { invoice: number | { id: number }, image: string | number } | [invoice: number | { id: number }, image: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: pdfImage.url(args, options),
    method: 'get',
})
...
* @route '/invoices/{invoice}/pdf-image/{image}'
*/
pdfImageForm.get = (args: { invoice: number | { id: number }, image: string | number } | [invoice: number | { id: number }, image: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: pdfImage.url(args, options),
    method: 'get',
})
...
* @route '/invoices/{invoice}/pdf-image/{image}'
*/
pdfImageForm.head = (args: { invoice: number | { id: number }, image: string | number } | [invoice: number | { id: number }, image: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: pdfImage.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'HEAD',
            ...(options?.query ?? options?.mergeQuery ?? {}),
        }
...
pdfImage.form = pdfImageForm

/**
* @see \App\Http\Controllers\InvoiceController::duplicate
* @see app/Http/Controllers/InvoiceController.php:161
...
* @see app/Http/Controllers/InvoiceController.php:72
...
* @see app/Http/Controllers/InvoiceController.php:150
* @route '/invoices/{invoice}'
*/
...
* @see app/Http/Controllers/InvoiceController.php:172
* @route '/invoices/{invoice}'
*/
...
/**
* @see \App\Http\Controllers\InvoiceController::status
* @see app/Http/Controllers/InvoiceController.php:183
* @route '/invoices/{invoice}/status'
*/
export const status = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
* @route '/invoices/{invoice}/status'
*/
status.url = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { invoice: args }
    }
...
* @route '/invoices/{invoice}/status'
*/
status.put = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: status.url(args, options),
    method: 'put',
})
...
* @route '/invoices/{invoice}/status'
*/
const statusForm = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/invoices/{invoice}/status'
*/
statusForm.put = (args: { invoice: number | { id: number } } | [invoice: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: status.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PUT',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const invoices = {
    searchItems: Object.assign(searchItems, searchItems),
    json: Object.assign(json, json),
    pdfImage: Object.assign(pdfImage, pdfImage),
