            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Import customer data from a CSV file</p>
                    </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                            ...
                            <form id="import-form" action="{{ route('import.customers') }}" method="POST" class="mt-6 hidden">
                                @csrf
                        ...
                        <div class="bg-primary-50 rounded-lg border border-blue-200 p-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <div>
                                    ...
                                    <ul class="text-sm text-primary-800 space-y-1">
                                        <li>• <code>contact_person</code> - Primary contact person</li>
                                        <li>• <code>contact_phone</code> - Phone number</li>
                                        <li>• <code>contact_email</code> - Email address</li>
                                ...
                                <div>
                                    ...
                                    <ul class="text-sm text-primary-800 space-y-1">
                                        ...
                                        <li>• Duplicate customer names will be skipped</li>
                                        <li>• Invalid email addresses will show warnings</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
...
name,contact_person,contact_phone,contact_email,address
"Acme Corporation","John Doe","(555) 123-4567","john@acme.com","123 Business St, Suite 100, New York, NY 10001"
"Global Tech Inc.","Jane Smith","(555) 987-6543","jane@globaltech.com","456 Tech Avenue, Palo Alto, CA 94301"
"Local Services LLC","Mike Johnson","(555) 246-8135","mike@local.com","789 Service Road, Chicago, IL 60601"</pre>
                        </div>
                    </div>
                </div>
            </div>
    ...
    container.innerHTML = `
        <div class="text-center py-4">
            <div class="inline-flex items-center">
                ...
                <span class="text-primary-600">Importing customers...</span>
            </div>
        </div>
    `;
}
