...
@php
    ...
    $baseClasses = 'block w-full px-4 py-3 border rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-offset-0 placeholder-gray-400 hover:border-gray-400 appearance-none cursor-pointer';
    ...
    // Determine the selected value: prioritize old() input, then explicit value, then null
